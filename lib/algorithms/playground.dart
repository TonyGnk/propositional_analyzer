...
myFunction() async {
  ...
  // List<int> temp = List.from(list.removeAt(0));
  // List<int> temp2 = List.from(temp);
  // print(list);
  // //Find the first 0 index in temp
  // int index = temp.indexOf(0);

  // //Change the value of the first 0 to 1
  // temp[index] = 1;
