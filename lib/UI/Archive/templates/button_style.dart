...
abstract class ButtonStyleButton2 extends StatefulWidget {
  /// Abstract const constructor. This constructor enables subclasses to provide
  /// const constructors so that they can be used in const expressions.
  const ButtonStyleButton2({
    required this.onPressed, required this.onLongPress, required this.onHover, required this.onFocusChange, required this.style, required this.focusNode, required this.autofocus, required this.clipBehavior, required this.child, super.key,
  ...
  @override
  State<ButtonStyleButton2> createState() => _ButtonStyleState();
...
/// See also:
///
///  * [ButtonStyleButton2], the [StatefulWidget] subclass for which this class is the [State].
///  * [ElevatedButton], a filled button whose material elevates when pressed.
///  * [FilledButton], a filled ButtonStyleButton that doesn't elevate when pressed.
///  * [OutlinedButton], similar to [TextButton], but with an outline.
///  * [TextButton], a simple button without a shadow.
class _ButtonStyleState extends State<ButtonStyleButton2>
  ...
  @override
  void didUpdateWidget(ButtonStyleButton2 oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    T? resolve<T>(
        MaterialStateProperty<T>? Function(ButtonStyle? style) getProperty) => effectiveValue(
    ...
    final Widget result = AnimatedContainer(
...
/// A widget to pad the area around a [ButtonStyleButton2]'s inner [Material].
///
...
class _InputPadding extends SingleChildRenderObjectWidget {
  const _InputPadding({
    required this.minSize, super.child,
  });
