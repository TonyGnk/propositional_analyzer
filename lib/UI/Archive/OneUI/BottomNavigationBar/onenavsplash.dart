...
const Duration _kUnconfirmedSplashDuration =
    kThemeAnimationDuration; //Duration(milliseconds: 11100)11100
const Duration _kSplashFadeDuration = kRadialReactionDuration;
const Duration _kReverseSplashFadeDuration =
    Duration(milliseconds: 300); //default 350
...
void paintInkRRect({
  ...
  final RRect inkRRect =
      RRect.fromRectAndRadius(inkRect, const Radius.circular(18.0)); //18
